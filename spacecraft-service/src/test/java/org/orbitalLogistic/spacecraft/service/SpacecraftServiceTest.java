...
class SpacecraftServiceTest {
    ...
    void getSpacecrafts_WithFilters() {
        ...
        PageResponseDTO<SpacecraftResponseDTO> result = spacecraftService.getSpacecrafts("Star", "AVAILABLE", 0, 10);
    ...
    void getSpacecraftById_NotFound() {
        ...
        assertThrows(SpacecraftNotFoundException.class, () -> spacecraftService.getSpacecraftById(999L));
    ...
    void createSpacecraft_Success() {
        ...
        SpacecraftResponseDTO result = spacecraftService.createSpacecraft(spacecraftRequest);

        assertNotNull(result);

        verify(spacecraftRepository).existsByRegistryCode(spacecraftRequest.registryCode());
        verify(spacecraftTypeService, times(2)).getEntityById(1L);
    ...
    void createSpacecraft_RegistryCodeAlreadyExists() {
        ...
        assertThrows(SpacecraftAlreadyExistsException.class,
                () -> spacecraftService.createSpacecraft(spacecraftRequest));
    ...
    void updateSpacecraft_Success() {
        ...
        SpacecraftResponseDTO result = spacecraftService.updateSpacecraft(1L, spacecraftRequest);
    ...
    void updateSpacecraft_NotFound() {
        ...
        assertThrows(SpacecraftNotFoundException.class,
                () -> spacecraftService.updateSpacecraft(999L, spacecraftRequest));
    ...
    void updateSpacecraftStatus_Success() {
        ...
        SpacecraftResponseDTO result = spacecraftService.updateSpacecraftStatus(1L, SpacecraftStatus.IN_TRANSIT);
    ...
    void spacecraftExists_True() {
        ...
        boolean exists = spacecraftService.spacecraftExists(1L);
    ...
    void spacecraftExists_False() {
        ...
        boolean exists = spacecraftService.spacecraftExists(999L);
    ...
    void getSpacecraftsScroll() {
        ...
        List<SpacecraftResponseDTO> result = spacecraftService.getSpacecraftsScroll(0, 10);
