...
class SpacecraftServiceExceptionTest {
    ...
    void getSpacecraftById_NotFound() {
        ...
        assertThrows(SpacecraftNotFoundException.class, () -> spacecraftService.getSpacecraftById(1L));
    }
    ...
    void createSpacecraft_AlreadyExists() {
        ...
        assertThrows(SpacecraftAlreadyExistsException.class, () -> spacecraftService.createSpacecraft(req));
    }

    @Test
    void deleteSpacecraft_NotFound() {
        when(spacecraftRepository.existsById(999L)).thenReturn(false);
        assertThrows(SpacecraftNotFoundException.class, () -> spacecraftService.deleteSpacecraft(999L));
    }
}
