...
//    private SignUpRequestDTO registrationRequest;
...
//                .build();
//
//        registrationRequest = new SignUpRequestDTO(
//                "newuser@example.com",
//                "newuser",
//                "password123"
//        );
...
//        when(userMapper.toEntity(any(SignUpRequestDTO.class))).thenReturn(testUser);
